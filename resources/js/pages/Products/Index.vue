    ...
    <ShopLayout>
        ...
        <section class="relative h-72 overflow-hidden sm:h-80 lg:h-[420px]">
            ...
            >
                <!-- Hero Card -->
                <div
                    class="max-w-md rounded-2xl bg-white/95 p-6 shadow-xl backdrop-blur-sm sm:p-8"
                >
                    <span
                        class="inline-block rounded-full bg-shop-orange px-4 py-1.5 text-xs font-bold tracking-wide text-white uppercase"
                    >
                        Fresh Weekly
                    </span>
                    <h1
                        class="mt-4 font-display text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl"
                    >
                        This Week's Menu
                    </h1>
                    <p class="mt-3 text-base text-gray-600 sm:text-lg">
                        Get cooking with fresh ingredients and chef-designed
